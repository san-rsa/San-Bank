...
/***/ "./src/declarations/sanBank/index.js":
/*!*******************************************!*\
  !*** ./src/declarations/sanBank/index.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "idlFactory": () => (/* reexport safe */ _sanBank_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory),
/* harmony export */   "canisterId": () => (/* binding */ canisterId),
/* harmony export */   "createActor": () => (/* binding */ createActor),
/* harmony export */   "sanBank": () => (/* binding */ sanBank)
/* harmony export */ });
...
/* harmony import */ var _sanBank_did_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sanBank.did.js */ "./src/declarations/sanBank/sanBank.did.js");
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./sanBank.did.js")._SERVICE>}
 */
 const createActor = (canisterId, options) => {
  ...
  return _dfinity_agent__WEBPACK_IMPORTED_MODULE_0__.Actor.createActor(_sanBank_did_js__WEBPACK_IMPORTED_MODULE_1__.idlFactory, {
    agent,
    canisterId,
...
/**
 * A ready-to-use agent for the sanBank canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./sanBank.did.js")._SERVICE>}
 */
 const sanBank = createActor(canisterId);


/***/ }),

/***/ "./src/declarations/sanBank/sanBank.did.js":
/*!*************************************************!*\
  !*** ./src/declarations/sanBank/sanBank.did.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
/*!*****************************************!*\
  !*** ./src/sanBank_assets/src/index.js ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _declarations_sanBank__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../declarations/sanBank */ "./src/declarations/sanBank/index.js");
...
document.querySelector("form").addEventListener("submit", async function(event) {
  ...
  if (document.getElementById("input-amount").value.length != 0) {
    await _declarations_sanBank__WEBPACK_IMPORTED_MODULE_0__.sanBank.add(inputAmount);
  }

  if (document.getElementById("withdrawal-amount").value.length != 0) {
    await _declarations_sanBank__WEBPACK_IMPORTED_MODULE_0__.sanBank.sub(outputAmount);
  }

  await _declarations_sanBank__WEBPACK_IMPORTED_MODULE_0__.sanBank.compoundInterest();
...
async function update() {
  const currentAmount = await _declarations_sanBank__WEBPACK_IMPORTED_MODULE_0__.sanBank.balance();
